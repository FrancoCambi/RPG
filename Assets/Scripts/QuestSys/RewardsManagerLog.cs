...
public class RewardsManagerLog : MonoBehaviour
{
	private static RewardsManagerLog instance;
	
	public static RewardsManagerLog Instance 
	{
		get 
		{
			if (instance == null) 
			{
				instance = FindObjectOfType<RewardsManagerLog>();
			}
