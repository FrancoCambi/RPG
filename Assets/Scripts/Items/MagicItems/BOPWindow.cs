...
public class BOPWindow : MonoBehaviour
{
	...
	public void Upgrade() 
	{
		...
		{
			CastBar.Instance.StartCast("Upgrading...", 2f, EndUpgrade);
		}
	}
	...
	private void SetOdds() 
	{
		if (toUpgrade is Sword) 
		{
			oddsText.text = "Success: " + EquipmentUpgrade.Probs[(toUpgrade as Sword).Upgrade + 1] + "%";
		}
		else 
		{
			oddsText.text = "Success: " + EquipmentUpgrade.Probs[(toUpgrade as Armor).Upgrade + 1] + "%";
		}
	}
