...
public static class EquipmentUpgrade
{
	...
	public static bool TryUpgrade(int original) 
	{
		...
		{
			MessageFeedManager.instance.WriteMessage("Upgrade successful! New grade: +" + (original + 1), FontSize.NORMAL, MessageType.Warning, 2f);
			return true;
		}
		else 
		{
			MessageFeedManager.instance.WriteMessage("Upgrade failed.. Better luck next time!", FontSize.NORMAL, MessageType.Warning, 2f);
			return false;
		}
